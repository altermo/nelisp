...
F.getenv_internal={'getenv-internal',1,2,0,[[Get the value of environment variable VARIABLE.
...
function M.init_syms()
    ...
    vars.defvar_forward('process_environment','process-environment',[[List of overridden environment variables for subprocesses to inherit.
